  ...
  <!-- Sidebar Menu Start -->
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  " href="../dashboard/index-boxed-fancy.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                        </svg>                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                            </g>
                                        </svg>
                                    </i>
                                    <i class="sidenav-mini-icon"> B </i>
                     ...
                     <li class="nav-item">
                        <a class="nav-link  {{ request()->routeIs('admin.currency') ? 'active' : '' }} " aria-current="page" href="{{Route('admin.currency')}}" target="_blank">
                            <i class="icon">
                            ...
                            <span class="item-name">Currency <span class="badge rounded-pill  item-name"><img width="25" height="25" src="https://img.icons8.com/ios-filled/25/6c757d/exchange-euro.png" alt="exchange-euro"/></span></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            <i class="icon">
                            <img class="icon-20" width="25" height="25" src="https://img.icons8.com/external-icongeek26-glyph-icongeek26/25/6c757d/external-map-bitcoin-icongeek26-glyph-icongeek26.png" alt="external-map-bitcoin-icongeek26-glyph-icongeek26"/>
                            </i>
...
>>>>>>> 7b075d4fa73b21dab7553060053ddb70b58228a8
                                  ...
                                  <img width="20" height="20" src="https://img.icons8.com/ios-filled/20/6c757d/travel-agency.png" alt="travel-agency"/>
                                  </i>
                                  <span class="item-name">Tour Created</span>
                                </a>
                            </li>
                            <li class="nav-item">
